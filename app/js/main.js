	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      if (this.state.current > this.state.questions.length) {
	        var scorebox = '';
	        var results = _react2['default'].createElement(_quizResultsJsx2['default'], this.state);
	      } else {
	        var scorebox = _react2['default'].createElement(_quizScoreBoxJsx2['default'], this.state);
	      }
	        ...
	        _react2["default"].createElement(
	          ...
	          question.choices.map(function (choice) {
	            return _react2["default"].createElement(
	              ...
	              choice.id,
	              " ",
	              _react2["default"].createElement("input", { type: "radio", onChange: _this.onChange.bind(_this), name: question.id, value: choice.id }),
	              choice.text
	            );
	          })
	        )
