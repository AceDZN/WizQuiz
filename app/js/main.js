...
/***/ function(module, exports, __webpack_require__) {
	...
	var _quizScoreBoxJsx = __webpack_require__(161);

	var _quizScoreBoxJsx2 = _interopRequireDefault(_quizScoreBoxJsx);

	var _quizResultsJsx = __webpack_require__(162);

	var _quizResultsJsx2 = _interopRequireDefault(_quizResultsJsx);

	var _quizQuestionListJsx = __webpack_require__(163);

	var _quizQuestionListJsx2 = _interopRequireDefault(_quizQuestionListJsx);

	var _AceLogoJsx = __webpack_require__(165);

	var _AceLogoJsx2 = _interopRequireDefault(_AceLogoJsx);
	  ...
	  function App(props) {
	    ...
	    this.state = {
	      questions: [{
	        ...
	        choices: [{ id: 'a', text: "Elephant" }, { id: 'b', text: "Siberian tiger" }, { id: 'c', text: "Whale" }],
	        correct: 'c'
	      }, {
	        id: 2,
	        text: "What is the national animal of Albania?",
	        choices: [{ id: 'a', text: "Eel fish" }, { id: 'b', text: "Golden eagle" }, { id: 'c', text: "Whale" }],
	        correct: 'b'
	      }, {
	        id: 3,
	        text: "Which animal is on the golden Flemish flag?",
	        choices: [{ id: 'a', text: "Lion" }, { id: 'b', text: "Dog" }, { id: 'c', text: "Eagle" }],
	        correct: 'a'
	      }, {
	        id: 4,
	        text: "From which cactus is tequila made?",
	        choices: [{ id: 'a', text: "Aloe-Vera" }, { id: 'b', text: "San Pedro" }, { id: 'c', text: "Agave" }],
	        correct: 'c'
	      }],
	      score: 0,
	      current: 1
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      if (this.state.current > this.state.questions.length) {
	        scorebox = '';
	        results = _react2['default'].createElement(_quizResultsJsx2['default'], this.state);
	      } else {
	        scorebox = _react2['default'].createElement(_quizScoreBoxJsx2['default'], this.state);
	        results = '';
	      }
	      return _react2['default'].createElement(
	        ...
	        scorebox,
	        results,
	        _react2['default'].createElement(_quizQuestionListJsx2['default'], _extends({}, this.state, { setCurrent: this.setCurrent.bind(this), setScore: this.setScore.bind(this) })),
	        _react2['default'].createElement(_AceLogoJsx2['default'], null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScoreBox = (function (_Component) {
	  _inherits(ScoreBox, _Component);

	  function ScoreBox() {
	    _classCallCheck(this, ScoreBox);

	    _get(Object.getPrototypeOf(ScoreBox.prototype), "constructor", this).apply(this, arguments);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionJsx = __webpack_require__(164);
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        this.props.questions.map(function (question) {
	          if (question.id == _this.props.current) {
	            return _react2['default'].createElement(_QuestionJsx2['default'], _extends({ question: question, key: question.id }, _this.props));
	          }
	        })
	      );
	    }
	...
	var Question = (function (_Component) {
	  ...
	  _createClass(Question, [{
	    ...
	    value: function onChange(e) {
	      ...
	      var setCurrent = _props.setCurrent;
	      var setScore = _props.setScore;
	        ...
	        _react2["default"].createElement(
	          ...
	          question.choices.map(function (choice) {
	            return _react2["default"].createElement(
	              ...
	              choice.id,
	              _react2["default"].createElement("input", { type: "radio", onChange: _this.onChange.bind(_this), id: question.id + "_" + choice.id, name: question.id, value: choice.id }),
	              _react2["default"].createElement(
	                "label",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AceLogo = (function (_Component) {
	  _inherits(AceLogo, _Component);

	  function AceLogo() {
	    _classCallCheck(this, AceLogo);

	    _get(Object.getPrototypeOf(AceLogo.prototype), "constructor", this).apply(this, arguments);
	  }

	  _createClass(AceLogo, [{
	    key: "render",
	    value: function render() {
	      return _react2["default"].createElement(
	        "div",
	        ...
	        _react2["default"].createElement(
	          "div",
	          { className: "col-xs-12 text-center ace-logo" },
	          _react2["default"].createElement(
	            "a",
	            { href: "http://www.acedzn.com", target: "_blank" },
	            _react2["default"].createElement(
	              "svg",
	              { width: "30px", height: "30px", viewBox: "0 0 350 350", version: "1.1" },
	              _react2["default"].createElement(
	                "g",
